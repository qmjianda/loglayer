    ...
    def _parse_time_config(self):
        ...
        if self.start_time:
            try:
                ...
                logger.warning(f"TimeRangeFilter invalid start_time: {e}")
        ...
        if self.end_time:
            try:
                ...
                logger.warning(f"TimeRangeFilter invalid end_time: {e}")
                self.end_time = None
...
class RelativeTimeFilterLayer(FilterLayer):
    ...
    def _calculate_cutoff(self):
        ...
        try:
            ...
            logger.warning(f"RelativeTimeFilter error calculating cutoff: {e}")
