...
const LoadingSkeleton: React.FC = () => (
  <div className="flex items-start gap-3 animate-pulse">
    <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-500/50 to-purple-600/50 flex items-center justify-center flex-shrink-0">
    ...
    <div className="flex-1 max-w-[75%] space-y-2">
      ...
      <div className="h-4 bg-theme-elevated rounded w-5/6" />
    </div>
  </div>
);
