...
export const IndexingOverlay: React.FC<IndexingOverlayProps> = ({ progress, fileName }) => (
  <div className="absolute inset-x-0 bottom-0 top-0 z-50 flex flex-col items-center justify-center bg-theme-base/80 backdrop-blur-sm transition-all">
    <div className="flex flex-col items-center p-8 rounded-2xl bg-theme-surface border border-white/10 shadow-2xl scale-in-center overflow-hidden relative">
...
export const FileLoadingSkeleton: React.FC<FileLoadingSkeletonProps> = ({ fileName }) => (
  <div className="absolute inset-x-0 bottom-0 top-0 z-40 bg-theme-base overflow-hidden">
    ...
    <div className="absolute inset-0 pointer-events-none">
      <div
        ...
        style={{
          background:
            'linear-gradient(90deg, transparent 0%, rgba(59, 130, 246, 0.08) 20%, rgba(59, 130, 246, 0.15) 50%, rgba(59, 130, 246, 0.08) 80%, transparent 100%)',
          ...
          >
            <div className="w-20 pr-4 flex justify-end shrink-0">
              <div
                ...
                style={{ width: `${lineNumWidth}px`, animationDelay: `${i * 50}ms` }}
              />
            </div>
            <div className="flex-1 flex items-center gap-2">
              <div
                className="h-3 bg-gray-600/40 rounded animate-pulse"
                style={{ width: `${contentWidth}%`, animationDelay: `${i * 50 + 25}ms` }}
              />
              {hasSecondBlock && (
                <div
                  className="h-3 bg-gray-700/30 rounded animate-pulse"
                  style={{ width: `${secondBlockWidth}%`, animationDelay: `${i * 50 + 50}ms` }}
                />
              )}
            </div>
          </div>
    ...
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      <div className="flex flex-col items-center gap-4 bg-theme-surface/95 px-8 py-6 rounded-xl border border-white/10 shadow-2xl backdrop-blur-sm">
...
export const PendingFilesWall: React.FC<{ count: number }> = ({ count }) => (
  <div className="flex-1 flex flex-col items-center justify-center text-gray-500 bg-theme-base">
    <div className="flex flex-col items-center gap-5">
      ...
      <div className="text-center">
        ...
        <p className="text-xs mt-1 text-gray-600">
          {count} {count === 1 ? 'file' : 'files'} remaining
        </p>
      </div>
