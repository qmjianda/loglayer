    ...
    <div className="w-12 bg-[#333333] flex flex-col items-center py-2 shrink-0 h-full border-r border-[#111]">
      {icons.map((item) => (
        <button
          ...
          className={`w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center relative group transition-colors ${activeView === item.id ? 'text-white' : 'text-gray-500 hover:text-gray-300'
            }`}
        >
          {activeView === item.id && (
      ...
      <div className="mt-auto">
        <button className="w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-gray-500 hover:text-gray-300">
